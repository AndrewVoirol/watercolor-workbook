...
export const JAPANESE_BRUSHES: JapaneseBrushOption[] = [
  {
    ...
    kanji: '丸筆',
    sub: 'Classic Round',
    description: 'Tapered animal hair for versatile expressive calligraphic strokes and soft Katabokashi washes',
  ...
  },
  {
    ...
    kanji: '面相筆',
    sub: 'Fine Liner',
    description: 'Long slender sable hair for hairline precision, delicate details, and crisp bone linework',
  ...
  },
  {
    ...
    kanji: '刷毛',
    sub: 'Flat Wash',
    description: 'Broad flat wooden wash brush for wide atmospheric washes & dry kasure striations',
